...
public class ProfileDTO{
	...
	public String toString() {
		return "ProfileDTO [Fname=" + Fname + ", Lname=" + Lname + ", PRid=" + PRid + ", Email=" + Email + ", Password="
				+ Password + ", Restriction=" + Restriction + ", Phone_num=" + Phone_num + ", Create_date=" + Create_date
				+ ", Country=" + Country + ", State=" + State + ", City=" + City + ", Street=" + Street + ", Nickname="
				+ Nickname + ", Gender=" + Gender + ", ProfileImg=" + ProfileImg + ", Role_id=" + Role_id + "]";
	}
